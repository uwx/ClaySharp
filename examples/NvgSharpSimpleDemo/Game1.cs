...
using ClaySharp.Renderer.NvgSharp;
...
/// <summary>
/// NvgSharp port of the ClaySharp FNA simple demo. Exercises rectangles, rounded corners,
/// borders, scissor clipping, text, and (via Space) a rounded-corner image — all rendered
/// through the NanoVG-style <see cref="NvgContext"/> instead of the FNA vertex-batching renderer.
/// </summary>
public class Game1 : Game
{
    ...
    private NvgContext _nvgContext = null!;
    private Nvg_Clay.NvgRendererData _rendererData;
    ...
    {
        _nvgContext = new NvgContext(GraphicsDevice, true);
        ...
        _rendererData = new Nvg_Clay.NvgRendererData
        {
            Context = _nvgContext,
    ...
    protected override void Draw(GameTime gameTime)
    {
        ...
        Nvg_Clay.RenderClayCommands(_rendererData, renderCommands);
